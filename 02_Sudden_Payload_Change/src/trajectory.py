...
def desired_trajectory(t):
    ...
    # Hold a fixed desired yaw so the experiment isolates payload-induced
    # translational/attitude effects rather than introducing an unnecessary
    # yaw maneuver at the initial condition.
    psi = 0.0

    # Fixed yaw means zero desired yaw rate.
    psi_dot = 0.0
